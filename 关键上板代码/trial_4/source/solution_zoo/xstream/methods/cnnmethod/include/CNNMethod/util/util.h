...
template <typename T>
void HNMS(std::vector<T> &candidates, std::vector<T> *result,
          const float overlap_ratio, const int top_N, const bool add_score,
...
inline void split_string(const std::string &s, std::vector<std::string> &v,
                         const std::string &c) {
