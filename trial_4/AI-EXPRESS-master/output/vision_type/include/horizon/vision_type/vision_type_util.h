...
/**
 * \~Chinese @brief
 * 复制landmarks结构，构造新的结构体并复制内容过来，然后返回新的结构体指针
 *
 * \~Chinese @param lmks [in] 源landmarks
...
/**
 * \~Chinese @brief
 * 复制HorizonVisionCharArray内容，复制数据到另一个结构体，相当于赋值操作
 *
...
/**
 * \~Chinese @brief
 * 复制HorizonVisionCharArray，构造新的结构体并复制内容过来，然后返回新的结构体指针
 *
 * \~Chinese @param array [in] 源HorizonVisionCharArray
...
/**
 * \~Chinese @brief
 * 复制FloatArray，构造新的结构体并复制内容过来，然后返回新的结构体指针
 *
...
/**
 * \~Chinese @brief
 * 复制分割结构体，构造新的结构体并复制内容过来，然后返回新的结构体指针
 *
 * \~Chinese @param farray [in] 源结构体指针
...
/**
 * \~Chinese @brief 复制 smart
 * snapshot，构造新的结构体并复制内容过来，然后返回新的结构体指针
 * **此处会复制抓拍图像帧数据
 *
 * \~Chinese @param snapshot [in] snapshot指针存储地址
...
/**
 * \~Chinese @brief 复制
 * image，构造新的结构体并复制内容过来，然后返回新的结构体指针
 *
...
/**
 * \~Chinese @brief 复制一个image
 * frame，构造新的结构体并复制内容过来，然后返回新的结构体指针
 *
...
/**
 * \~Chinese @brief 复制 snapshot
 * target，构造新的结构体并复制内容过来，然后返回新的结构体指针
 * **此处会复制抓拍图像帧数据
 *
 * \~Chinese @param target [in] snapshot target 指针存储地址
