...
```json
// common/xstream/framework/tutorials/stage7/config/filter.json
 1    {
 2      "inputs": [
 3        "head_box"
 4      ],
...
```C++
// xstream/framework/tutorials/stage7/include/method/bbox.h
...
```C++
// xstream/framework/tutorial/stage7/include/method/bbox_filter_a.h
...
```C++
// xstream/framework/tutorial/stage7/include/method/callback.h
...
```C++
// xstream/framework/tutorials/stage7/include/method/method_factory.cc
...
```C++
// xstream/framework/tutorial/stage7/src/main.cc
...
进入xstream/framework/目录下，执行如下命令，运行stage7_main

```bash
cd xstream/framework/tutorial/stage7
cp -rf ../../../tutorials/stage7/config/ .
./stage7_main
```
