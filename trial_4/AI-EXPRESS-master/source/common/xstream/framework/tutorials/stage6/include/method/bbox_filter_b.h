...
#ifndef XSTREAM_FRAMEWORK_TUTORIALS_STAGE6_INCLUDE_METHOD_BBOX_FILTER_B_H_
#define XSTREAM_FRAMEWORK_TUTORIALS_STAGE6_INCLUDE_METHOD_BBOX_FILTER_B_H_
...
#endif  // XSTREAM_FRAMEWORK_TUTORIALS_STAGE6_INCLUDE_METHOD_BBOX_FILTER_B_H_
