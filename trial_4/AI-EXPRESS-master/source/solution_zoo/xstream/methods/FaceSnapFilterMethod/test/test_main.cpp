...
typedef xstream::XStreamData<hobot::vision::BBox> XRocBBox;
typedef xstream::XStreamData<hobot::vision::Pose3D> XRocPose3D;
typedef xstream::XStreamData<hobot::vision::Landmarks> XRocLandmarks;
typedef xstream::XStreamData<hobot::vision::Quality> XRocQuality;
typedef xstream::XStreamData<hobot::vision::Age> XRocAge;
typedef xstream::XStreamData<hobot::vision::Gender> XRocGender;
typedef xstream::XStreamData<hobot::vision::Attribute<int32_t>> XRocAttribute;
typedef xstream::XStreamData<int32_t> XRocFilterDescription;
...
class FaceSnapFilterMethodParam : public xstream::InputParam {
 public:
...
TEST_F(FaceSnapFilterMethodTest, default_config) {
  ...
  for (size_t i = 0; i < face_box_.size(); ++i) {
