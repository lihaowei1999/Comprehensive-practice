...
class FaceSnapFilterMethod : public SimpleMethod {
 ...
 private:
  ...
  typedef XStreamData<hobot::vision::Pose3D> XRocPose3D;
  typedef XStreamData<hobot::vision::Landmarks> XRocLandmarks;
  typedef XStreamData<hobot::vision::Quality> XRocQuality;
  typedef XStreamData<hobot::vision::Age> XRocAge;
  typedef XStreamData<hobot::vision::Gender> XRocGender;
  typedef XStreamData<hobot::vision::Attribute<int32_t>> XRocAttribute;
  typedef XStreamData<int32_t> XRocFilterDescription;
 ...
 * */
 ...
 private:
  ...
  std::vector<std::string> input_data_types_ = {"bbox",
                                                ...
                                                "mouth",
                                                "jaw"};
  std::vector<std::string> input_data_dark_types_ = {"bbox",
                                                "pose3D",
                                                "landmark",
                                                "blur",
                                                "brightness",
