...
bool VioPipeConfig::ParserConfig() {
  ...
  // 2.1 sensor config
  if (json_[pipe_name]["vin"]["sensor"].isMember("sensor_id")) {
    vio_cfg_.vin_cfg.sensor_info.sensor_id =
      json_[pipe_name]["vin"]["sensor"]["sensor_id"].asInt();
  }
  if (json_[pipe_name]["vin"]["sensor"].isMember("plugin_en")) {
    vio_cfg_.vin_cfg.sensor_info.plugin_en =
      json_[pipe_name]["vin"]["sensor"]["plugin_en"].asInt();
  }
  if (json_[pipe_name]["vin"]["sensor"].isMember("sensor_path")) {
    vio_cfg_.vin_cfg.sensor_info.sensor_path =
      json_[pipe_name]["vin"]["sensor"]["sensor_path"].asString();
  }
  if (json_[pipe_name]["vin"]["sensor"].isMember("sensor_name")) {
    vio_cfg_.vin_cfg.sensor_info.sensor_name =
      json_[pipe_name]["vin"]["sensor"]["sensor_name"].asString();
  }
  if (json_[pipe_name]["vin"]["sensor"].isMember("sensor_type")) {
    vio_cfg_.vin_cfg.sensor_info.sensor_type =
      json_[pipe_name]["vin"]["sensor"]["sensor_type"].asInt();
  }
...
bool VioPipeConfig::PrintConfig() {
  ...
  LOGI << "plugin_en: "    << vio_cfg_.vin_cfg.sensor_info.plugin_en;
  LOGI << "sensor_path: "    << vio_cfg_.vin_cfg.sensor_info.sensor_path;
  LOGI << "sensor_name: "    << vio_cfg_.vin_cfg.sensor_info.sensor_name;
  LOGI << "sensor_type: "    << vio_cfg_.vin_cfg.sensor_info.sensor_type;
