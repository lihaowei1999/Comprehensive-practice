...
class HorizonH264ServerMediaSubsession : public OnDemandServerMediaSubsession {
 public:
  static HorizonH264ServerMediaSubsession *createNew(UsageEnvironment &env,
...
class MetadataFramedSource : public FramedSource {
 public:
  static MetadataFramedSource *createNew(UsageEnvironment &env, bool sendH264,
  ...
  bool needH264() { return sendH264; }

  bool needImage() { return sendImage; }

  bool needBackground() { return sendBackground; }

  bool needSmart() { return sendSmart; }

  bool needFeature() { return sendFeature; }
 ...
 protected:
  MetadataFramedSource(UsageEnvironment &env, bool sendH264, bool sendImage,
                       bool sendSmart, bool sendFeature, bool sendBackground);
...
class MetadataServerMediaSubsession : public OnDemandServerMediaSubsession {
 public:
  static MetadataServerMediaSubsession *createNew(UsageEnvironment &env,
                                                  Boolean reuseFirstSource,
                                                  char *key, char *value);
 ...
 protected:
  MetadataServerMediaSubsession(UsageEnvironment &env, Boolean reuseFirstSource,
                                char *key, char *value);
