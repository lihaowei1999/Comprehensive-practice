...
typedef enum hbrt_layout_type_t {
  ...
  LAYOUT_NCWH_ZHW_8N16C_ENCODE,
  LAYOUT_NCWH_ZHW_16N8C_ENCODE,
  LAYOUT_NCWH_ZHW_8N4C_ENCODE,
  LAYOUT_NCWH_ZHW_4N8C_ENCODE,
  LAYOUT_NCWH_ZHW_32N8C_ENCODE,
  LAYOUT_NCWH_ZHW_16N16C_ENCODE,
  ...
  // ALWAYS ADD NEW LAYOUT AT THE BOTTOM!
  // DO NOT REMOVE DEPRECATED LAYOUTS
  LAYOUT_NUM,
